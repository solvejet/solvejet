// src/app/(website)/case-studies/error.tsx
'use client';
...
export default function CaseStudiesError({
  ...
  useEffect(() => {
    ...
    trackEvent({
      name: 'case_studies_error',
      category: 'error',
      label: 'case_studies_error',
      properties: {
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center bg-white rounded-lg shadow-md p-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            We encountered an error while loading the case studies. Please try again later.
          </p>
