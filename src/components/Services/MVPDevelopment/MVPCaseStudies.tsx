// src/components/Services/MVPDevelopment/MVPCaseStudies.tsx
'use client';
...
interface MVPCaseStudiesProps {
  className?: string;
}

export default function MVPCaseStudies({ className }: MVPCaseStudiesProps): React.ReactElement {
  ...
  useEffect(() => {
    // Filter case studies to show relevant ones for MVP development
    ...
    // Track view event
    trackEvent({
      name: 'mvp_case_studies_view',
      category: 'engagement',
      label: 'mvp_development_case_studies',
    });
        ...
        <div className="max-w-7xl sm:ml-0 ml-0 md:pt-0">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-16 leading-relaxed max-w-3xl">
              Discover how we've helped startups and established businesses launch successful MVPs
              that validated business models, attracted initial users, and secured funding.
            </p>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="w-full h-64 relative">
                  ...
                  <div className="absolute top-6 left-6 px-4 py-1.5 bg-pink-500 text-white text-sm font-medium rounded-full">
                    {caseStudy.industry}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    {caseStudy.results.metrics.slice(0, 2).map((metric, idx) => (
                      <div key={idx} className="bg-white dark:bg-gray-800 p-4 rounded-xl">
                        <div className="text-2xl font-bold text-pink-500">{metric.value}</div>
          ...
          <Link href="/case-studies">
            <TrackedButton
              ...
              trackingEvent={{
                ...
                category: 'navigation',
                label: 'view_all_case_studies_from_mvp',
              }}
            >
