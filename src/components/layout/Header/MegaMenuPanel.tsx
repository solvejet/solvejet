...
function MegaMenuPanelComponent({
  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-black rounded-b-xl shadow-2xl border border-gray-800 border-t-0 overflow-hidden">
        <div className="flex flex-col md:flex-row">
          {/* Sidebar/header with title and featured content - takes 30% on desktop */}
          <div className="w-full md:w-1/3 bg-gradient-to-br from-gray-900 to-gray-800 p-6 md:p-8">
            <div className="h-full flex flex-col">
              {activeMegaMenu.title && (
                <div className="mb-6">
                  <span className="text-xs font-semibold uppercase tracking-wider text-element-400">
                    {openMegaMenu}
                  </span>
                  <h3 className="text-2xl md:text-3xl font-bold mt-1 text-white">
                    {activeMegaMenu.title}
                  </h3>
                  {activeMegaMenu.description && (
                    <p className="mt-3 text-gray-300">{activeMegaMenu.description}</p>
                  )}
                </div>
              )}
              ...
              <div className="mt-auto">
                <div className="p-4 bg-gray-800/80 rounded-lg border border-gray-700 shadow-lg">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <TrackedButton
                        variant="default"
                        size="sm"
                        className="mt-3 bg-element-600 text-white hover:bg-element-700"
          ...
          <div className="w-full md:w-2/3 p-6 md:p-8 bg-black">
                  ...
                  <ul className="space-y-3">
                    {column.items.map((item, itemIndex) => (
                      ...
                      >
                        <Link
                          href={item.href}
                          className="group block p-3 -mx-3 rounded-lg transition-all duration-200 hover:bg-gray-800/60"
                          onClick={(): void => {
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center justify-between">
                                ...
                                <ChevronRight className="h-4 w-4 text-gray-500 group-hover:text-element-400 opacity-0 group-hover:opacity-100 transition-all transform -translate-x-2 group-hover:translate-x-0" />
                              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-800 flex flex-wrap gap-3">
              <span className="text-sm text-gray-400">Popular resources: </span>
              <Link
                href="/privacy-policy"
