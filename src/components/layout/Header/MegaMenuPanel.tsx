...
function MegaMenuPanelComponent({
  ...
  return (
    <div
      className={cn(
        'backdrop-blur-md bg-white/80 dark:bg-gray-900/90',
        'transition-all duration-300 ease-in-out overflow-hidden',
        closing ? 'max-h-0 opacity-0 scale-y-95' : 'max-h-[800px] opacity-100 scale-y-100'
      )}
      style={{ transformOrigin: 'top' }}
    >
      {/* Modern card design with sidebar layout */}
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="bg-gradient-to-br from-gray-50/70 to-white/70 dark:from-gray-800/70 dark:to-gray-900/70 rounded-xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                          Our experts are ready to help with your {openMegaMenu.toLowerCase()}{' '}
                          needs.
                        </p>
                        <TrackedButton
                          variant="default"
